package com.example.welcome.webveiwdemo;
...
//                    clearFBcoockies();
    ...
    public void clearFB() {
        ...
        android.webkit.CookieManager.getInstance().setCookie(".facebook.com", "sb=");
        ...
        /*cookieManager.setCookie("m_pixel_ratio","");
        cookieManager.setCookie("fr","");
        cookieManager.setCookie("sb","");
        cookieManager.setCookie("c_user","");
        cookieManager.setCookie("xs","");
        cookieManager.setCookie("pl","");
        cookieManager.setCookie("lu","");*/

        Log.d("ExampleMain", "clearFB"+CookieManager.getInstance().getCookie("https://facebook.com"));
/*        Log.d("ExampleMain", cookieManager.getCookie("m_pixel_ratio"));
        Log.d("ExampleMain", cookieManager.getCookie("fr"));
        Log.d("ExampleMain", cookieManager.getCookie("sb"));
        Log.d("ExampleMain",cookieManager.getCookie("c_user"));
        Log.d("ExampleMain",cookieManager.getCookie("xs"));
        Log.d("ExampleMain",cookieManager.getCookie("pl"));
        Log.d("ExampleMain",cookieManager.getCookie("lu"));*/
